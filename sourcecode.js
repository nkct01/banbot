...
(function () {
    ...
    var botCreator = "The Basicbot Team";
    var botMaintainer = "ArkhamNetwork"
    var botCreatorIDs = ["8452233"];
    ...
    var basicBot = {
        ...
        settings: {
            ...
            language: "english",
            chatLink: "https://rawgit.com/smashbro12/arkhamBot/master/lang/en.json",
            scriptLink: "https://raw.githubusercontent.com/smashbro12/arkhamBot/master/SourceCodeEdit",
            ...
            commandLiteral: "!",
            blacklists: {
                NSFW: "https://rawgit.com/smashbro12/arkhamBot/master/blacklists/bl.json",
                OP: "https://rawgit.com/smashbro12/arkhambot/master/blacklists/OPlist.json",
                BANNED: "https://rawgit.com/smashbro12/arkhambot/master/blacklists/BANNEDlist.json"
            }
        },
        room: {
            name: null,
            ...
            sourceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat('/me This bot was created by The Basicbot Team, but is now maintained by ArkhamNetwork.");
                    }
                }
            },
